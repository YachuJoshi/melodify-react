  ...
  return (
    <Waypoint onEnter={() => setIsCtaVisible(true)}>
      <div className={styles.cta__textWrapper}>
        ...
        >
          Over 30 million tracks; thousands of curated playlists; Discover
          Weekly; Melodify Running; Radio; Chromecast, sound system, car, TV and
          PlayStation intregation; sharing and creating playlists with your
          friends... All of this is ready for you.
        </p>
        <Link to="/webplayer">
          <button
            className={
