  ...
  return (
    <>
      <header id="header" className={styles.header}>
        ...
        <div className={`${styles.mainWrapper}`}>
          <h1 className={styles.headerText}>
            <span className={styles.headerText__main}>Your Very Own</span>
          ...
          <div className={styles.header__buttons}>
            <Link to="/webplayer">
              <Button type="FREE">Get Melodify Free</Button>
            </Link>
            <Button type="PREMIUM">Get Melodify Premium</Button>
          </div>
        </div>
      </header>
      ...
      <section className={styles.sectionTestimonials}>
        ...
        <TestimonialBox customers={customers} />
        <a
          href="#"
          className={
            isTestimonialVisible
      ...
      <section className={styles.sectionCTA}>
        <div className={`${styles.divCTA} row`}>
          <CTASideBar />
          <ImageComposition composition={composition} />
        </div>
      </section>
